...
def run_test():
    ...
    try:
        print(f'Recording {DURATION_S} seconds of audio. Make some noise (speak, clap, etc.)!\n')
        audio_file = os.path.join(tempfile.gettempdir(), f'tjbot_test_{int(time.time())}.wav')
